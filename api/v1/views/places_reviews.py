#!/usr/bin/python3
"""
To Create a new view for Review objects - handles all default RESTful API
"""
...
def get_reviews_by_place(place_id):
    """
    To Retrieves the list of all Review objects of a Place
    """
