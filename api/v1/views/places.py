#!/usr/bin/python3
"""
To Create a view for Place objects - handles all default RESTful API actions
"""
...
def get_places_by_city(city_id):
    """
    To Retrieve the list of all Place objects of a City
    """
...
def bad_request(error):
    """
    To Return Bad Request message for illegal requests to the API
    """
...
def places_search():
    """
    To Retrieves Place objects based on the provided JSON search criteria
    """
