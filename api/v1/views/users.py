#!/usr/bin/python3
"""
To Create a new view for User objects - handles all default RESTful API actions
"""
...
def get_all_users():
    """
    To retrieves the list of all User objects
    """
