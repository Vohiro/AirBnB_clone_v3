#!/usr/bin/python3
"""
To Create a new view for City objects - handles all default RESTful API actions.
"""
...
def get_cities_by_state(state_id):
    """
    To Retrieves the list of all City objects of a State.
    """
...
def bad_request(error):
    """
    To Return Bad Request message for illegal requests to API.
    """
